...
export default function City({ onSelectDome }) {
  ...
  return (
    <group>
      ...
      {/* ── LAYER 1: Critical scene foundation — loads first ── */}
      {/* These are the most visible things: floor, mountains, roads, domes */}
      {/* Everything above this comment is already rendered (floor, roads, domes, etc.) */}

      {/* ── LAYER 2: Large landmark models ── */}
      <Suspense fallback={null}>
        ...
        {/* ── LAYER 3: Dome area models — loads after layer 2 ── */}
        <Suspense fallback={null}>
          {/* DOME 0 area */}
          ...
          {/* ── LAYER 4: Detail models — loads last ── */}
          <Suspense fallback={null}>
            {/* VEHICLES */}
            <Model
