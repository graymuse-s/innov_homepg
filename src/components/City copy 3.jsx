...
export default function City({ onSelectDome }) {
  ...
  return (
    <group>
      ...
      {/* ════════════════════════════════════════════
          LAYER 2 — Big structures visible from far away
          (~8 models, loads second)
          ════════════════════════════════════════════ */}
      <Suspense fallback={null}>
        ...
        {/* ════════════════════════════════════════════
            LAYER 3 — Hub details, animals, vehicles, people
            (~16 models + instanced groups, loads third)
            ════════════════════════════════════════════ */}
        <Suspense fallback={null}>
          {/* Defense hub details */}
          <Model
          ...
          {/* ════════════════════════════════════════════
              LAYER 4 — Small details, people, tiny props
              (~14 models + instanced groups, loads last)
              ════════════════════════════════════════════ */}
          <Suspense fallback={null}>
            {/* Dome 0 small details */}
            <group position={getCornerPos(0)}>
