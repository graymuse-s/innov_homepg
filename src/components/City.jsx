...
function SkyLogoI({ position = [0, 140, -80], size = 500 }) {
...
function Ambulance({ position }) {
  const { scene } = useGLTF("/models/ambulance.glb");
...
function Bench2({ position }) {
  const { scene } = useGLTF("/models/bench2.glb");
...
function Kids_Bot({ position }) {
  const { scene } = useGLTF("/models/kids_bot.glb");
  ...
  return (
    <group rotation={[0, angle, 0]}>
      ...
      <mesh position={[radius, 0.02, 0]} rotation={[-Math.PI / 2, 0, 0]}>
        <planeGeometry args={[16, radius * 1.15]} />
...
export default function City({ onSelectDome }) {
  ...
  return (
    <group onPointerMissed={() => onSelectDome(null)}>
      ...
      <Rikshaw position={[5, 4, -100]} />
      <Scooty position={[-100, 6, 50]} />
      ...
      <Water position={[4, -2, 0]} />

      <Bush position={[112, 2, -30]} />
      <Bush2 position={[110, 2, -30]} />
      <Bush3 position={[108, 2, -31]} />
      <Parent position={[100, 2, -31]} />
      <School1 position={[-150, 5, 70]} />
      <SkyLogoI position={[0, -200, -2200]} scale={90} />

      <Bench position={[-130, 5, 140]} />
      <Bench2 position={[-120, 5, 160]} />
      <Boundary position={[-150, 5, 70]} />
      <CycleStand position={[-155, 0, 105]} />
      <Bycycle position={[-145, 1.3, 102]} />
      <Bycycle1 position={[-148, 1.3, 103]} />
      <Bycycle2 position={[-152, 1.3, 104]} />
      <Bycycle3 position={[-156, 1.3, 105]} />

      <SolarPanels position={[10, 7, -131]} />
      <Windmill position={[20, 10, -155]} />
      <Student position={[-110, 8, 110]} />
      <Park position={[-60, 5, 150]} />
      <Park_slide position={[-50, 10, 150]} />
      <Park_swing position={[-74, 7, 150]} />
      <Kids_Bot position={[-65, 5, 165]} />
      <Ambulance position={[80, 5, 145]} />

      <SeeSaw position={[-60, 2.5, 133]} />
      <Boys position={[-70, 5, 165]} />
...
=======
      <Suspense fallback={null}>
        ...
        {[0, 1, 2, 3, 4, 5, 6].map((i) => {
          const pos = i === 6 ? [0, 4, 0] : getCornerPos(i);
          return (
            <Dome key={i} position={pos} onClick={() => onSelectDome(pos)} />
          );
        })}
>>>>>>> Stashed changes
