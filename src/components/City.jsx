...
export default function City({
    ...
    const mountainData = useMemo(
        () => [
            ...
            { position: [-160, 0, -220], scale: [600, 250, 150], rotation: [0, 0, 0] },
            ...
            { position: [320, 15, -15], scale: [330, 250, 400], rotation: [0, Math.PI, 0] },
            { position: [260, 15, 120], scale: 200, rotation: [0, Math.PI, 0] },
            { position: [-260, 0, -140], scale: [600, 250, 150], rotation: [Math.PI / 8, Math.PI / 6, 0] },
