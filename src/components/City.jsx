    ...
    return (
        ...
        <group onPointerMissed={() => onSelectDome(null)}>
            ...
            <Suspense fallback={null}>
                ...
                <Model path="/models/plus.glb" position={[89, 12, 127]} scale={5} rotation={[0, 0, 0]} />
                <Model path="/models/ambulance.glb" position={[84, 5, 60]} scale={15} rotation={[0, Math.PI / 3, 0]} />
                ...
                <Model path="/models/bench.glb" position={[-105, 6, 150]} scale={20} rotation={[0, Math.PI / 7, 0]} />
                ...
                <Model path="/models/bridge.glb" position={[30, 5, 40]} scale={0} rotation={[0, 2 * Math.PI / 3, 0]} />
                ...
                <group position={getCornerPos(3)}>
                    ...
                    <Model path="/models/farmhouse.glb" position={[-70, -4, -70]} scale={15} rotation={[0, 0, 0]} />

                    <Model path="/models/sheep.glb" position={[-40, 0, -70]} scale={2.5} rotation={[0, 0, 0]} />
                    <Model path="/models/sheep.glb" position={[-50, 0, -70]} scale={2.5} rotation={[0, Math.PI, 0]} />


                    <Model path="/models/goat.glb" position={[-80, 2, 30]} scale={2} rotation={[0, - Math.PI / 6, 0]} />
                    <Model path="/models/goat.glb" position={[-80, 2, 10]} scale={2} rotation={[0, Math.PI / 6, 0]} />
                    ...
                    <Model path="/models/chicken.glb" position={[-40, -0.5, -12]} scale={4} rotation={[0, 1.5, 0]} />
                    <Model path="/models/chicken.glb" position={[-48, -0.5, -18]} scale={4} rotation={[0, 1.5, 0]} />
                ...
                <group position={getCornerPos(0)}>
                    ...
                    <Model path="/models/resbuilding.glb" position={[38.5, 8, 7]} scale={16} rotation={[0, Math.PI / 2, 0]} />
                    <Model path="/models/car.glb" position={[38.5, 1, 20]} scale={12} rotation={[0, Math.PI / 2, 0]} />
                    <Model path="/models/car.glb" position={[38.5, 1, 27]} scale={12} rotation={[0, Math.PI / 2, 0]} />
                ...
                <Suspense fallback={null}>
                    <group position={getCornerPos(0)}>
                        ...
                        <Model path="/models/solarpanels.glb" position={[8, 8, 43]} scale={12} rotation={[Math.PI / 4 + 1, 11.6, 1.8]} />
                        <Model path="/models/solarpanels.glb" position={[4, 7.9, 57]} scale={12} rotation={[Math.PI / 4 + 1, 11.5, 1.9]} />
                        <Model path="/models/car.glb" position={[25.5, 1, 27]} scale={12} rotation={[0, Math.PI / 2, 0]} />
                        <Model path="/models/car.glb" position={[25.5, 1, 34]} scale={12} rotation={[0, Math.PI / 2, 0]} />
                        <Model path="/models/car.glb" position={[38.5, 1, 34]} scale={12} rotation={[0, Math.PI / 2, 0]} />
                    ...
                    <group position={getCornerPos(3)}>
                        {/* 3. COWS (6 Units) */}
                        <Model path="/models/Cow.glb" position={[-40, 1, -3]} scale={25} rotation={[0, 0.5, 0]} />
                        <Model path="/models/Cow.glb" position={[-45, 1, -82]} scale={25} rotation={[0, 1.2, 0]} />
                        <Model path="/models/Cow.glb" position={[-55, 1, -84]} scale={25} rotation={[0, -0.8, 0]} />
                        <Model path="/models/Cow.glb" position={[-48, 1, -2]} scale={25} rotation={[0, 2.5, 0]} />
                        <Model path="/models/Cow.glb" position={[-35, 1, -75]} scale={25} rotation={[0, 0, 0]} />
                        <Model path="/models/Cow.glb" position={[-35, 1, -87]} scale={25} rotation={[0, 3.1, 0]} />
                        {/* 4. HORSES (4 Units) */}
                        <Model path="/models/Horse.glb" position={[-30, -0.5, 40]} scale={15} rotation={[0, 1.5, 0]} />
                        <Model path="/models/Horse.glb" position={[-25, -0.5, 25]} scale={15} rotation={[0, -1.0, 0]} />
                        <Model path="/models/Horse.glb" position={[-14, -0.5, 35]} scale={15} rotation={[0, 0.2, 0]} />
                        <Model path="/models/Horse.glb" position={[-29, -.5, 35]} scale={15} rotation={[0, 2.1, 0]} />
                        <Model path="/models/chicken.glb" position={[-41, -0.5, -15]} scale={4} rotation={[0, 1.5, 0]} />
                        <Model path="/models/chicken.glb" position={[-43, -0.5, -10]} scale={4} rotation={[0, 0.5, 0]} />
                        <Model path="/models/chicken.glb" position={[-41, -0.5, -20]} scale={4} rotation={[0, 5.5, 0]} />
                        <Model path="/models/chicken.glb" position={[-45, -0.5, -16]} scale={4} rotation={[0, 4.5, 0]} />
                        <Model path="/models/chicken.glb" position={[-48, -0.5, -12]} scale={4} rotation={[0, 1.5, 0]} />
                    </group>
                    ...
                    <Model path="/models/robo.glb" position={[15, 7, 140]} scale={8} rotation={[0, -0.6, 0]} />
                    <Model path="/models/robo.glb" position={[77, 3, 130]} scale={7} rotation={[0, -0.6, 0]} />
                    ...
                    <Model path="/models/grass.glb" position={[110, 4, -30]} scale={5} rotation={[0, -0.6, 0]} />
                    <Model path="/models/grass.glb" position={[108, 4, -31]} scale={5} rotation={[0, -0.6, 0]} />
                    ...
                    <Model path="/models/bycycle.glb" position={[-115, 7, 118]} scale={10} rotation={[0, Math.PI / 0.9, 0]} />
                    <Model path="/models/bycycle.glb" position={[-112, 7, 115]} scale={10} rotation={[0, Math.PI / 0.9, 0]} />
                    <Model path="/models/bycycle.glb" position={[-110, 7, 114]} scale={10} rotation={[0, Math.PI / 0.9, 0]} />

                    <Model
                        path="/models/base_army.glb" position={[-5, 8, -135]} scale={50} rotation={[0, Math.PI, 0]} />

                    <Model path="/models/base_army.glb" position={[-5, 8, -135]} scale={50} rotation={[0, Math.PI, 0]} />
